...
Select distinct vendor_id, count(booth_number) as count_of_booth_renting 
...
sum(c.purchased_amount) as total_purchase
from (
Select a.customer_id, a.customer_first_name,
a.customer_last_name,
b.quantity,
b.cost_to_customer_per_qty,
(b.quantity * b.cost_to_customer_per_qty) as purchased_amount from customer a
left join customer_purchases b
on a.customer_id = b.customer_id) AS c
group by c.customer_id, c.customer_first_name, c.customer_last_name
having sum(c.purchased_amount) > 2000
order by customer_last_name, customer_first_name
